...
M.fuelUsage = 0
M.engineLoad = 0
M.shifterMode = 2 -- initial value needs to fit the two modes below
M.shifterPosition = 0
M.wheelCount = 0
M.avgAV = 0
M.engineAV = 0
...
local function init()
  ...
  -- <custom>
  -- obj:queueGameEngineLua("extensions.addModulePath('lua/vehicle/extensions/ui_base')")
  -- obj:queueGameEngineLua("extensions.loadModulesInDirectory('lua/vehicle/extensions/ui_base')")

  obj:queueGameEngineLua("extensions.addModulePath('lua/ge/extensions/ui_base')")
  obj:queueGameEngineLua("extensions.loadModulesInDirectory('lua/ge/extensions/ui_base')")
  -- </custom>
end
